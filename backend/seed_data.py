...
def seed_roadmaps(db):
    ...
    roadmap = [
        {"step": 1, "skill": "sql_basics", "content_type": "video"},
        {"step": 2, "skill": "python_basics", "content_type": "video"},
        {"step": 3, "skill": "stats_basics", "content_type": "video"},
    ]

    print("🔄 Seeding demo roadmap...")
    db.roadmaps.delete_many({})

    result = db.roadmaps.insert_one(
        {
            "user_id": "demo_user",
            "goal": "Data Analyst",
            "topic": "Data Analyst",
    ...
    print("✅ Added demo roadmap")
    return str(result.inserted_id)


def seed_progress(db, roadmap_id=None):
    """Seed behavior to trigger adaptation."""
    print("🔄 Seeding demo progress...")
    db.progress.delete_many({})

    progress_data = [
        {"step_id": 1, "step_number": 1, "skipped": True, "time_spent": 5, "attempts": 1},
        {"step_id": 2, "step_number": 2, "skipped": True, "time_spent": 4, "attempts": 1},
        {"step_id": 3, "step_number": 3, "skipped": False, "time_spent": 200, "attempts": 3},
    ]
